    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        if (args == null || args.length < 1) {
            ...
            if (player == null) {
                ...
                sender.addChatMessage(new TextComponentTranslation("command.pacify.add.one", player.getName()));
                Pacify.setPacifiedState(player, true);
            }
        } else {
            ...
            for (String name : args) {
                ...
                if (player == null) {
                    ...
                    sender.addChatMessage(new TextComponentTranslation("command.pacify.add.already", player.getName()));
                    return;
                }
            ...
            for (int i = 0; i < playerList.size(); i++) {
                ...
                out.append(I18n.translateToLocalFormatted(i == 0 ? "command.pacify.add.one" : "command.pacify.followups", player.getName()));
                Pacify.setPacifiedState(player, true);
            }
